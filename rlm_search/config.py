...
print(f"[CONFIG] cascade={CASCADE_API_URL} backend={RLM_BACKEND} model={RLM_MODEL} max_iter={RLM_MAX_ITERATIONS} max_depth={RLM_MAX_DEPTH} backend_port={SEARCH_BACKEND_PORT} frontend_port={SEARCH_FRONTEND_PORT}")
