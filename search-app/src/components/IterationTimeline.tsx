...
import { extractFinalAnswer } from '@/lib/types';
...
function getIterationStats(iteration: Iteration) {
  let totalSubCalls = 0;
  let codeExecTime = 0;
  let hasError = false;
  ...
  return (
    <div className="border-b border-border bg-muted/30 flex-shrink-0">
      ...
      <div className="px-4 pt-3 pb-2 flex items-center gap-2">
        ...
        <span className="text-xs font-semibold text-foreground">Execution Trajectory</span>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1 text-[9px] font-mono text-muted-foreground/70">
                      <span>
                        ...
                        <span className="mx-0.5">tok</span>
                      </span>
